<?php
/*
Template Name: Contact Page PPCM
*/
?>
...
if(isset($_POST['submitted'])) {
	...
	if(trim($_POST['checking']) !== '') {
		...
		if(!isset($hasError)) {
			...
			if($sendCopy == true) {
				$subject = $subject.' at PPCM';
				$headers = 'From:  Pelri Pema Choling Monastery, <noreply@pelripcmonastery.org>';
...
<section id="content">
	<div class="container">
		<div class="row">
			...
			<div class="row">
			<div class="col-lg-12">
			<!--<iframe src="https://www.google.com/maps/embed/v1/place?q=27.426264,+89.442109&key=AIzaSyAN0om9mFmy1QN6Wf54tXAowK4eT0ZUPrU" width="100%" height="250px" frameborder="0" style="border:0"></iframe>-->
			</div>
		</div>
		</div>
	</div>
