...
<tr>
<td style="width: 100%">Movie Contact</td>
<td><input type="text" size="80"
name="movie_review_contact_name"
value="<?php echo $movie_contact; ?>" /></td>
</tr>
<tr>
...
if ( isset( $_POST['movie_review_contact_name'] ) &&
$_POST['movie_review_contact_name'] != '' ) {
update_post_meta( $movie_review_id, 'movie_contact',
$_POST['movie_review_contact_name'] );
}
